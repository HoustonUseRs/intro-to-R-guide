...
```{r eval = FALSE}
select(crickets, Chirpspersecond) %>% mean()
select(crickets, Chirpspersecond) %>% median()
select(crickets, Chirpspersecond) %>% sd()
select(crickets, Temperature) %>% mean()
select(crickets, Temperature) %>% median()
select(crickets, Temperature) %>% sd()
```

We can also ask R for the max and the min values:

```{r eval = FALSE}
select(crickets, Chirpspersecond) %>% max()
select(crickets, Chirpspersecond) %>% min()
select(crickets, Temperature) %>% max()
select(crickets, Temperature) %>% min()
```
