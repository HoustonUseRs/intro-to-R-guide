...
We can run these functions on our data by using `crickets$Chirpspersecond` as the x, and `crickets$Temperature` as the y like so:
...
You can see that we've calculated the correlation coefficient and run a Pearson's product moment correlation coefficient.
