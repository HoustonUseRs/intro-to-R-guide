...
We'll model the data using reliable `lm()` function again. Let's add the following to our script and *Source* it. 
...
Great. Now, what if we want to make a report of our work? With R, you get the power of `knitr`, which will _knit_ your work together into a report. Let's try it on our current script. Go to File -> Knit Document and select HTML, then watch the magic happen!
