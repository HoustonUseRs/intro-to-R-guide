...
1. Practice making a script and a report with a larger dataset
    1. Loading in the data
    1. Exploring it
    1. **Cleaning it**
    1. Visualizing it
...
1. Explore and practice openly with a full dataset
